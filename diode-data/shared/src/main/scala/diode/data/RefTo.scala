...
import diode.{FastEq, ModelR, ModelRO}
...
object RefTo {
  ...
  @inline def apply[V](target: ModelRO[V], updated: V => AnyRef): RefTo[V] =
  ...
  /**
    ...
    */
  @inline def apply[K, V, P](key: K, collTarget: ModelRO[P])(updated: (K, Pot[V]) => AnyRef)(implicit ev: P <:< PotCollection[K, V]): RefTo[Pot[V]] =
  ...
  /**
    ...
    * @param updated      Function to create an update action for the potential value this reference points to
    */
  @inline def stream[K, V, P](key: K, streamTarget: ModelRO[P])(updated: (K, V) => AnyRef)(implicit ev: P <:< PotStream[K, V], feq: FastEq[_ >: V]): RefTo[V] =
